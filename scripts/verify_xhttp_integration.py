...
SOURCE_ASSERTIONS = {
    ...
    ROOT / "scripts/generate_apk.py": (
        ...
        "patch_xhttp_ping_refresh",
        "patch_selector_catalog_sync",
        "TunnelManagerThread$4.smali",
    ...
    ROOT / "scripts/xhttp-smali/TunnelManagerThread$4.smali": (
        "Publish every successful ping",
        "-$$Nest$fputlastPingLatency",
        "Le4/g;->b(Landroid/content/Context;Ljava/lang/String;)V",
    ),
    ROOT / "scripts/generate_apk.py": (
        "Ponto de abertura do seletor z4/q.H não encontrado.",
        "PanelCatalogSync;->start",
        "verify_xhttp_runtime",
        "XHttpLauncher;->start",
        "patch_config_catalog_refresh",
        "patch_panel_catalog_http_sync",
