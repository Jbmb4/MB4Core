...
.method public constructor <init>(Lokiio/Source;)V
    ...
    .line 496
    invoke-interface {p1}, Lokiio/BufferedSource;->readUtf8LineStrict()Ljava/lang/String;
    ...
    invoke-virtual {v2, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lokiio/BufferedSource;)I
    ...
    .line 534
    invoke-direct {p0, p1}, Lokhttp3/Cache$Entry;->readCertificateList(Lokiio/BufferedSource;)Ljava/util/List;
    ...
    .line 536
    invoke-interface {p1}, Lokiio/BufferedSource;->exhausted()Z
...
.method private final readCertificateList(Lokiio/BufferedSource;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lokiio/BufferedSource;)I
    ...
    .line 611
    new-instance v5, Lokiio/Buffer;

    invoke-direct {v5}, Lokiio/Buffer;-><init>()V

    .line 612
    sget-object v6, Lokiio/ByteString;->Companion:Lokiio/ByteString$Companion;

    invoke-virtual {v6, v4}, Lokiio/ByteString$Companion;->decodeBase64(Ljava/lang/String;)Lokiio/ByteString;
    ...
    .line 613
    invoke-virtual {v5, v4}, Lokiio/Buffer;->write(Lokiio/ByteString;)Lokiio/Buffer;

    .line 614
    invoke-virtual {v5}, Lokiio/Buffer;->inputStream()Ljava/io/InputStream;
...
.method private final writeCertList(Lokiio/BufferedSink;Ljava/util/List;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lokiio/BufferedSink;->writeDecimalLong(J)Lokiio/BufferedSink;
    ...
    .line 628
    sget-object v2, Lokiio/ByteString;->Companion:Lokiio/ByteString$Companion;
    ...
    invoke-static/range {v2 .. v7}, Lokiio/ByteString$Companion;->of$default(Lokiio/ByteString$Companion;[BIIILjava/lang/Object;)Lokiio/ByteString;
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 563
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lokiio/Sink;
    ...
    invoke-interface {v1, v6}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;

    move-result-object v6

    .line 569
    invoke-interface {v6, v5}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
    ...
    invoke-interface {v5, v6}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;

    move-result-object v5

    .line 571
    invoke-interface {v5, v3}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    invoke-interface {v1, v6, v7}, Lokiio/BufferedSink;->writeDecimalLong(J)Lokiio/BufferedSink;
    ...
    .line 578
    invoke-interface {v4, v5}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
    ...
    invoke-interface {v4, v6}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;

    move-result-object v4

    .line 580
    invoke-interface {v4, v3}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    invoke-interface {v1, v0}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;

    move-result-object v0

    .line 583
    invoke-interface {v0, v5}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
    ...
    invoke-interface {v0, v6, v7}, Lokiio/BufferedSink;->writeDecimalLong(J)Lokiio/BufferedSink;

    move-result-object v0

    .line 585
    invoke-interface {v0, v3}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    invoke-interface {v0, v4, v5}, Lokiio/BufferedSink;->writeDecimalLong(J)Lokiio/BufferedSink;
    ...
    invoke-direct {p0, v1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lokiio/BufferedSink;Ljava/util/List;)V
