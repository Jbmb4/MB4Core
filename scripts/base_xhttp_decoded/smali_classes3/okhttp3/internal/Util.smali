...
.field private static final UNICODE_BOMS:Lokiio/Options;
...
.method static constructor <clinit>()V
    ...
    .line 70
    sget-object v1, Lokiio/Options;->Companion:Lokiio/Options$Companion;

    const/4 v2, 0x5

    .line 71
    new-array v2, v2, [Lokiio/ByteString;

    sget-object v3, Lokiio/ByteString;->Companion:Lokiio/ByteString$Companion;

    const-string v4, "efbbbf"

    invoke-virtual {v3, v4}, Lokiio/ByteString$Companion;->decodeHex(Ljava/lang/String;)Lokiio/ByteString;
    ...
    .line 70
    invoke-virtual {v1, v2}, Lokiio/Options$Companion;->of([Lokiio/ByteString;)Lokiio/Options;

    move-result-object v1

    sput-object v1, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokiio/Options;
...
.method public static final discard(Lokiio/Source;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    ...
    .line 365
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/Util;->skipAll(Lokiio/Source;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static final isCivilized(Lokhttp3/internal/io/FileSystem;Ljava/io/File;)Z
    ...
    .line 541
    invoke-interface {p0, p1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lokiio/Sink;
...
.method public static final isHealthy(Ljava/net/Socket;Lokiio/BufferedSource;)Z
    .locals 2
...
.method public static final readBomAsCharset(Lokiio/BufferedSource;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    .locals 1
    ...
    .line 265
    sget-object v0, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokiio/Options;

    invoke-interface {p0, v0}, Lokiio/BufferedSource;->select(Lokiio/Options;)I
...
.method public static final readMedium(Lokiio/BufferedSource;)I
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 324
    invoke-interface {p0}, Lokiio/BufferedSource;->readByte()B
...
.method public static final skipAll(Lokiio/Buffer;B)I
    .locals 3
    ...
    .line 421
    :goto_0
    invoke-virtual {p0}, Lokiio/Buffer;->exhausted()Z
...
.method public static final skipAll(Lokiio/Source;ILjava/util/concurrent/TimeUnit;)Z
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v2}, Lokiio/Timeout;->hasDeadline()Z
    ...
    invoke-virtual {v2}, Lokiio/Timeout;->deadlineNanoTime()J
    ...
    invoke-virtual {v2, p1, p2}, Lokiio/Timeout;->deadlineNanoTime(J)Lokiio/Timeout;
    ...
    .line 344
    invoke-interface {p0, p1, v7, v8}, Lokiio/Source;->read(Lokiio/Buffer;J)J
    ...
    invoke-virtual {p0}, Lokiio/Timeout;->clearDeadline()Lokiio/Timeout;
    ...
    invoke-virtual {p0, v0, v1}, Lokiio/Timeout;->deadlineNanoTime(J)Lokiio/Timeout;
...
.method public static final toHeaders(Ljava/util/List;)Lokhttp3/Headers;
    ...
    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component1()Lokiio/ByteString;

    move-result-object v2

    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component2()Lokiio/ByteString;
...
.method public static final writeMedium(Lokiio/BufferedSink;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 317
    invoke-interface {p0, v0}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    .line 319
    invoke-interface {p0, p1}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
