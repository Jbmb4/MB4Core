...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sink",
        "Lokiio/BufferedSink;",
        "(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokiio/BufferedSource;Lokiio/BufferedSink;)V",
        "getConnection",
        "()Lokhttp3/internal/connection/RealConnection;",
        "headersReader",
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokiio/BufferedSource;Lokiio/BufferedSink;)V
    .locals 1
    ...
    .line 69
    iput-object p3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lokiio/BufferedSource;

    .line 70
    iput-object p4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokiio/BufferedSink;

    .line 73
    new-instance p1, Lokhttp3/internal/http1/HeadersReader;

    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lokiio/BufferedSource;)V
...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Lokiio/ForwardingTimeout;)V
    .locals 0

    .line 64
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(Lokiio/ForwardingTimeout;)V
...
.method public static final synthetic access$getSink$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lokiio/BufferedSink;
    .locals 0

    .line 64
    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokiio/BufferedSink;

    return-object p0
.end method

.method public static final synthetic access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lokiio/BufferedSource;
    .locals 0

    .line 64
    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lokiio/BufferedSource;
...
.method private final detachTimeout(Lokiio/ForwardingTimeout;)V
    .locals 2

    .line 251
    invoke-virtual {p1}, Lokiio/ForwardingTimeout;->delegate()Lokiio/Timeout;

    move-result-object v0

    .line 252
    sget-object v1, Lokiio/Timeout;->NONE:Lokiio/Timeout;

    invoke-virtual {p1, v1}, Lokiio/ForwardingTimeout;->setDelegate(Lokiio/Timeout;)Lokiio/ForwardingTimeout;
...
.method private final newChunkedSink()Lokiio/Sink;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lokiio/Source;
    .locals 2
...
.method private final newFixedLengthSource(J)Lokiio/Source;
    .locals 2
...
.method private final newKnownLengthSink()Lokiio/Sink;
    .locals 2
...
.method private final newUnknownLengthSource()Lokiio/Source;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lokiio/Sink;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lokiio/Sink;
    ...
    .line 96
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lokiio/Sink;
...
.method public finishRequest()V
    ...
    .line 155
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokiio/BufferedSink;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lokiio/Source;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lokiio/Source;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lokiio/Source;
    ...
    .line 139
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lokiio/Source;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lokiio/Source;ILjava/util/concurrent/TimeUnit;)Z

    .line 266
    invoke-interface {p1}, Lokiio/Source;->close()V
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
    ...
    .line 163
    iget-object v2, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokiio/BufferedSink;

    invoke-virtual {p1, v1}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v3}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
    ...
    .line 166
    invoke-interface {v2, v0}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
    ...
    .line 168
    :cond_0
    iget-object p1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokiio/BufferedSink;

    invoke-interface {p1, v0}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
