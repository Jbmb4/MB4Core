...
.method private final readChunkSize()V
    ...
    invoke-static {v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lokiio/BufferedSource;

    move-result-object v1

    invoke-interface {v1}, Lokiio/BufferedSource;->readUtf8LineStrict()Ljava/lang/String;
    ...
    invoke-interface {v1}, Lokiio/BufferedSource;->readHexadecimalUnsignedLong()J
...
.method public read(Lokiio/Buffer;J)J
    ...
    invoke-super {p0, p1, p2, p3}, Lokhttp3/internal/http1/Http1ExchangeCodec$AbstractSource;->read(Lokiio/Buffer;J)J
