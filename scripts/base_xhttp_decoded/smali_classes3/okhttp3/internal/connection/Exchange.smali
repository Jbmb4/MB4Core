...
.method public final createRequestBody(Lokhttp3/Request;Z)Lokiio/Sink;
    .locals 3
    ...
    invoke-interface {p2, p1, v0, v1}, Lokhttp3/internal/http/ExchangeCodec;->createRequestBody(Lokhttp3/Request;J)Lokiio/Sink;
    ...
    invoke-direct {p2, p0, p1, v0, v1}, Lokhttp3/internal/connection/Exchange$RequestBodySink;-><init>(Lokhttp3/internal/connection/Exchange;Lokiio/Sink;J)V

    check-cast p2, Lokiio/Sink;
...
.method public final openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    invoke-interface {v3, p1}, Lokhttp3/internal/http/ExchangeCodec;->openResponseBodySource(Lokhttp3/Response;)Lokiio/Source;
    ...
    invoke-direct {v3, p0, p1, v1, v2}, Lokhttp3/internal/connection/Exchange$ResponseBodySource;-><init>(Lokhttp3/internal/connection/Exchange;Lokiio/Source;J)V
    ...
    invoke-direct {p1, v0, v1, v2, v3}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLokiio/BufferedSource;)V
