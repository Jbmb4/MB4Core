...
.field private final hpackBuffer:Lokiio/Buffer;
...
.method public constructor <init>(Lokiio/BufferedSink;Z)V
    .locals 7
    ...
    .line 46
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokiio/BufferedSink;

    .line 47
    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Writer;->client:Z

    .line 49
    new-instance v4, Lokiio/Buffer;

    invoke-direct {v4}, Lokiio/Buffer;-><init>()V

    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokiio/Buffer;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLokiio/Buffer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    .line 285
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokiio/BufferedSink;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokiio/Buffer;

    invoke-interface {v0, v1, v2, v3}, Lokiio/BufferedSink;->write(Lokiio/Buffer;J)V
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 79
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokiio/BufferedSink;
...
.method public final declared-synchronized connectionPreface()V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lokiio/ByteString;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lokiio/ByteString;

    invoke-interface {v0, v1}, Lokiio/BufferedSink;->write(Lokiio/ByteString;)Lokiio/BufferedSink;
...
.method public final declared-synchronized data(ZILokiio/Buffer;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 153
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILokiio/Buffer;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILokiio/Buffer;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, p3, v0, v1}, Lokiio/BufferedSink;->write(Lokiio/Buffer;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {p1, v5}, Lokhttp3/internal/Util;->writeMedium(Lokiio/BufferedSink;I)V
    ...
    invoke-interface {p1, p2}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    invoke-interface {p1, p2}, Lokiio/BufferedSink;->writeInt(I)Lokiio/BufferedSink;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lokiio/BufferedSink;->writeInt(I)Lokiio/BufferedSink;
    ...
    invoke-interface {p1, p3}, Lokiio/BufferedSink;->write([B)Lokiio/BufferedSink;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    .line 298
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokiio/Buffer;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokiio/Buffer;

    invoke-interface {p1, v4, v2, v3}, Lokiio/BufferedSink;->write(Lokiio/Buffer;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lokiio/BufferedSink;->writeInt(I)Lokiio/BufferedSink;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 111
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokiio/BufferedSink;

    const v5, 0x7fffffff

    and-int/2addr p2, v5

    invoke-interface {v2, p2}, Lokiio/BufferedSink;->writeInt(I)Lokiio/BufferedSink;

    .line 112
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokiio/BufferedSink;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokiio/Buffer;

    invoke-interface {p2, v2, v3, v4}, Lokiio/BufferedSink;->write(Lokiio/Buffer;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 186
    :goto_1
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokiio/BufferedSink;

    invoke-interface {v3, v0}, Lokiio/BufferedSink;->writeShort(I)Lokiio/BufferedSink;
    ...
    invoke-interface {v0, v3}, Lokiio/BufferedSink;->writeInt(I)Lokiio/BufferedSink;
