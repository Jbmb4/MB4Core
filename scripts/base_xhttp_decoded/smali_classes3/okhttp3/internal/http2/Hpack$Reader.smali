...
# direct methods
.method public constructor <init>(Lokiio/Source;I)V
    .locals 7
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokiio/Source;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V

    return-void
.end method

.method public constructor <init>(Lokiio/Source;II)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lokiio/BufferedSource;
...
.method public synthetic constructor <init>(Lokiio/Source;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    .line 125
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokiio/Source;II)V
...
.method private final getName(I)Lokiio/ByteString;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Lokiio/ByteString;
...
.method private final readByte()I
    ...
    .line 339
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lokiio/BufferedSource;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 270
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lokiio/ByteString;

    move-result-object p1

    .line 271
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lokiio/ByteString;
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lokiio/ByteString;Lokiio/ByteString;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lokiio/ByteString;)Lokiio/ByteString;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lokiio/ByteString;Lokiio/ByteString;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lokiio/ByteString;Lokiio/ByteString;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lokiio/ByteString;Lokiio/ByteString;)V
...
.method public final readByteString()Lokiio/ByteString;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lokiio/BufferedSource;

    move-object v5, v0

    check-cast v5, Lokiio/BufferedSink;

    invoke-virtual {v1, v4, v2, v3, v5}, Lokhttp3/internal/http2/Huffman;->decode(Lokiio/BufferedSource;JLokiio/BufferedSink;)V
    ...
    invoke-interface {v0, v2, v3}, Lokiio/BufferedSource;->readByteString(J)Lokiio/ByteString;
