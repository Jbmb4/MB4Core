...
.method public constructor <init>(Lokiio/BufferedSource;Z)V
    .locals 6
    ...
    .line 60
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokiio/BufferedSource;
    ...
    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lokiio/BufferedSource;)V
    ...
    .line 64
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokiio/Source;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 177
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokiio/BufferedSource;

    invoke-interface {v1}, Lokiio/BufferedSource;->readByte()B
    ...
    .line 180
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokiio/BufferedSource;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILokiio/BufferedSource;I)V

    .line 181
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokiio/BufferedSource;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lokiio/BufferedSource;->skip(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 294
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokiio/BufferedSource;

    invoke-interface {p4}, Lokiio/BufferedSource;->readInt()I

    move-result p4

    .line 295
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokiio/BufferedSource;

    invoke-interface {v0}, Lokiio/BufferedSource;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, Lokiio/BufferedSource;->readByteString(J)Lokiio/ByteString;

    move-result-object v0

    .line 303
    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lokiio/ByteString;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 284
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokiio/BufferedSource;

    invoke-interface {p2}, Lokiio/BufferedSource;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 196
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokiio/BufferedSource;

    invoke-interface {v3}, Lokiio/BufferedSource;->readByte()B
...
.method private final readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, Lokiio/BufferedSource;->readInt()I
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v3}, Lokiio/BufferedSource;->readShort()S
    ...
    .line 223
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokiio/BufferedSource;

    invoke-interface {v4}, Lokiio/BufferedSource;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v0, v1, v2}, Lokiio/BufferedSource;->require(J)V
    :try_end_0
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lokiio/BufferedSource;)I
    ...
    invoke-interface {p1, v0, v1}, Lokiio/BufferedSource;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v0, v1}, Lokiio/BufferedSource;->readByteString(J)Lokiio/ByteString;
    ...
    invoke-virtual {p1}, Lokiio/ByteString;->hex()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lokiio/ByteString;->utf8()Ljava/lang/String;
