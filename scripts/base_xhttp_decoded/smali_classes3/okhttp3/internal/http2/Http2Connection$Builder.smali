...
.field public sink:Lokiio/BufferedSink;

.field public socket:Ljava/net/Socket;

.field public source:Lokiio/BufferedSource;
...
.method public static synthetic socket$default(Lokhttp3/internal/http2/Http2Connection$Builder;Ljava/net/Socket;Ljava/lang/String;Lokiio/BufferedSource;Lokiio/BufferedSink;ILjava/lang/Object;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 0
    ...
    invoke-static {p3}, Lokiio/Okio;->buffer(Lokiio/Source;)Lokiio/BufferedSource;
    ...
    invoke-static {p4}, Lokiio/Okio;->buffer(Lokiio/Sink;)Lokiio/BufferedSink;

    move-result-object p4

    .line 573
    :cond_2
    invoke-virtual {p0, p1, p2, p3, p4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lokiio/BufferedSource;Lokiio/BufferedSink;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final getSink$okhttp()Lokiio/BufferedSink;
    .locals 1

    .line 567
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lokiio/BufferedSink;
...
.method public final getSource$okhttp()Lokiio/BufferedSource;
    .locals 1

    .line 566
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lokiio/BufferedSource;
...
.method public final setSink$okhttp(Lokiio/BufferedSink;)V
    .locals 1
    ...
    .line 567
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lokiio/BufferedSink;
...
.method public final setSource$okhttp(Lokiio/BufferedSource;)V
    .locals 1
    ...
    .line 566
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lokiio/BufferedSource;
...
.method public final socket(Ljava/net/Socket;)Lokhttp3/internal/http2/Http2Connection$Builder;
    ...
    invoke-static/range {v1 .. v7}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket$default(Lokhttp3/internal/http2/Http2Connection$Builder;Ljava/net/Socket;Ljava/lang/String;Lokiio/BufferedSource;Lokiio/BufferedSink;ILjava/lang/Object;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final socket(Ljava/net/Socket;Ljava/lang/String;Lokiio/BufferedSource;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public final socket(Ljava/net/Socket;Ljava/lang/String;Lokiio/BufferedSource;Lokiio/BufferedSink;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 584
    invoke-virtual {p0, p3}, Lokhttp3/internal/http2/Http2Connection$Builder;->setSource$okhttp(Lokiio/BufferedSource;)V

    .line 585
    invoke-virtual {p0, p4}, Lokhttp3/internal/http2/Http2Connection$Builder;->setSink$okhttp(Lokiio/BufferedSink;)V
