...
.field private final readBuffer:Lokiio/Buffer;

.field private final receiveBuffer:Lokiio/Buffer;
...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Stream;JZ)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lokiio/Buffer;
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokiio/Buffer;
...
.method public close()V
    ...
    .line 478
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokiio/Buffer;
    ...
    .line 479
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokiio/Buffer;

    invoke-virtual {v3}, Lokiio/Buffer;->clear()V
...
.method public final getReadBuffer()Lokiio/Buffer;
    .locals 1

    .line 328
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokiio/Buffer;

    return-object v0
.end method

.method public final getReceiveBuffer()Lokiio/Buffer;
    .locals 1

    .line 325
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lokiio/Buffer;
...
.method public read(Lokiio/Buffer;J)J
    ...
    .line 360
    iget-object v8, v1, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokiio/Buffer;
    ...
    invoke-virtual {v8, v0, v12, v13}, Lokiio/Buffer;->read(Lokiio/Buffer;J)J
...
.method public final receive$okhttp(Lokiio/BufferedSource;J)V
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 427
    iget-object v6, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokiio/Buffer;
    ...
    .line 444
    :cond_4
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lokiio/Buffer;

    invoke-interface {p1, v4, v0, v1}, Lokiio/BufferedSource;->read(Lokiio/Buffer;J)J
    ...
    .line 453
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lokiio/Buffer;

    invoke-virtual {v2}, Lokiio/Buffer;->clear()V

    goto :goto_4

    .line 455
    :cond_5
    iget-object v5, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokiio/Buffer;

    invoke-virtual {v5}, Lokiio/Buffer;->size()J
    ...
    .line 456
    :goto_3
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokiio/Buffer;

    iget-object v3, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lokiio/Buffer;

    check-cast v3, Lokiio/Source;

    invoke-virtual {v2, v3}, Lokiio/Buffer;->writeAll(Lokiio/Source;)J
