...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Connection$Builder;->getSink$okhttp()Lokiio/BufferedSink;

    move-result-object v4

    invoke-direct {v2, v4, v0}, Lokhttp3/internal/http2/Http2Writer;-><init>(Lokiio/BufferedSink;Z)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Connection$Builder;->getSource$okhttp()Lokiio/BufferedSource;

    move-result-object v5

    invoke-direct {v4, v5, v0}, Lokhttp3/internal/http2/Http2Reader;-><init>(Lokiio/BufferedSource;Z)V
...
.method public final pushDataLater$okhttp(ILokiio/BufferedSource;IZ)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 935
    new-instance v6, Lokiio/Buffer;

    invoke-direct {v6}, Lokiio/Buffer;-><init>()V

    int-to-long v0, p3

    .line 936
    invoke-interface {p2, v0, v1}, Lokiio/BufferedSource;->require(J)V

    .line 937
    invoke-interface {p2, v6, v0, v1}, Lokiio/BufferedSource;->read(Lokiio/Buffer;J)J
    ...
    invoke-direct/range {v1 .. v8}, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$default$1;-><init>(Ljava/lang/String;ZLokhttp3/internal/http2/Http2Connection;ILokiio/Buffer;IZ)V
...
.method public final writeData(IZLokiio/Buffer;J)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p4, p2, p1, p3, v3}, Lokhttp3/internal/http2/Http2Writer;->data(ZILokiio/Buffer;I)V
    ...
    :goto_2
    invoke-virtual {v4, v5, p1, p3, v2}, Lokhttp3/internal/http2/Http2Writer;->data(ZILokiio/Buffer;I)V
