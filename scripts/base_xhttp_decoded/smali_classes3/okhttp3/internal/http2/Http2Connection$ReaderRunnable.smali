...
.method public alternateService(ILjava/lang/String;Lokiio/ByteString;Ljava/lang/String;IJ)V
    .locals 0
...
.method public data(ZILokiio/BufferedSource;I)V
    .locals 2
    ...
    invoke-virtual {v0, p2, p3, p4, p1}, Lokhttp3/internal/http2/Http2Connection;->pushDataLater$okhttp(ILokiio/BufferedSource;IZ)V
    ...
    .line 647
    invoke-interface {p3, v0, v1}, Lokiio/BufferedSource;->skip(J)V

    return-void

    .line 650
    :cond_1
    invoke-virtual {v0, p3, p4}, Lokhttp3/internal/http2/Http2Stream;->receiveData(Lokiio/BufferedSource;I)V
...
.method public goAway(ILokhttp3/internal/http2/ErrorCode;Lokiio/ByteString;)V
    .locals 3
