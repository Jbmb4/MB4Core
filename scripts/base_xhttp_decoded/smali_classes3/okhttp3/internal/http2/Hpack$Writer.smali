...
.field private final out:Lokiio/Buffer;
...
# direct methods
.method public constructor <init>(ILokiio/Buffer;)V
    .locals 7
...
.method public constructor <init>(IZLokiio/Buffer;)V
    .locals 1
    ...
    .line 395
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lokiio/Buffer;
...
.method public synthetic constructor <init>(IZLokiio/Buffer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    .line 392
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLokiio/Buffer;)V

    return-void
.end method

.method public constructor <init>(Lokiio/Buffer;)V
    .locals 7
...
.method public final writeByteString(Lokiio/ByteString;)V
    .locals 4
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Lokiio/ByteString;)I
    ...
    check-cast v3, Lokiio/BufferedSink;

    invoke-virtual {v2, p1, v3}, Lokhttp3/internal/http2/Huffman;->encode(Lokiio/ByteString;Lokiio/BufferedSink;)V
    ...
    .line 573
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lokiio/Buffer;
...
.method public final writeHeaders(Ljava/util/List;)V
    ...
    .line 482
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:Lokiio/ByteString;

    invoke-virtual {v4}, Lokiio/ByteString;->toAsciiLowercase()Lokiio/ByteString;

    move-result-object v4

    .line 483
    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:Lokiio/ByteString;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/Header;->value:Lokiio/ByteString;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->name:Lokiio/ByteString;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->value:Lokiio/ByteString;
    ...
    .line 523
    iget-object v6, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lokiio/Buffer;

    invoke-virtual {v6, v8}, Lokiio/Buffer;->writeByte(I)Lokiio/Buffer;

    .line 524
    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lokiio/ByteString;)V

    .line 525
    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lokiio/ByteString;)V
    ...
    .line 528
    :cond_9
    sget-object v7, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Lokiio/ByteString;

    invoke-virtual {v4, v7}, Lokiio/ByteString;->startsWith(Lokiio/ByteString;)Z

    move-result v7

    if-eqz v7, :cond_a

    sget-object v7, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lokiio/ByteString;
...
.method public final writeInt(III)V
    ...
    .line 549
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lokiio/Buffer;

    or-int/2addr p1, p3

    invoke-virtual {p2, p1}, Lokiio/Buffer;->writeByte(I)Lokiio/Buffer;
    ...
    invoke-virtual {v0, p3}, Lokiio/Buffer;->writeByte(I)Lokiio/Buffer;
    ...
    invoke-virtual {v0, p2}, Lokiio/Buffer;->writeByte(I)Lokiio/Buffer;
