...
.field private journalWriter:Lokiio/BufferedSink;
...
.method public static final synthetic access$setJournalWriter$p(Lokhttp3/internal/cache/DiskLruCache;Lokiio/BufferedSink;)V
    .locals 0

    .line 87
    iput-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lokiio/BufferedSink;
...
.method private final newJournalWriter()Lokiio/BufferedSink;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lokiio/Sink;
    ...
    invoke-direct {v1, v0, v2}, Lokhttp3/internal/cache/FaultHidingSink;-><init>(Lokiio/Sink;Lkotlin/jvm/functions/Function1;)V

    .line 307
    check-cast v1, Lokiio/Sink;

    invoke-static {v1}, Lokiio/Okio;->buffer(Lokiio/Sink;)Lokiio/BufferedSink;
...
.method private final readJournal()V
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lokiio/Source;
    ...
    check-cast v3, Lokiio/BufferedSource;

    .line 264
    invoke-interface {v3}, Lokiio/BufferedSource;->readUtf8LineStrict()Ljava/lang/String;
    ...
    .line 292
    invoke-interface {v3}, Lokiio/BufferedSource;->exhausted()Z
    ...
    .line 295
    :cond_0
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()Lokiio/BufferedSink;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lokiio/BufferedSink;
...
.method public declared-synchronized close()V
    ...
    .line 679
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lokiio/BufferedSink;

    invoke-static {v0}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    invoke-interface {v0}, Lokiio/BufferedSink;->close()V
...
.method public final declared-synchronized completeEdit$okhttp(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    .line 550
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lokiio/BufferedSink;
    ...
    invoke-interface {p1, p2}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;

    move-result-object p2

    invoke-interface {p2, v4}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    .line 564
    invoke-interface {p1, v3}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    invoke-interface {p1, v1}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;

    move-result-object v1

    invoke-interface {v1, v4}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    .line 555
    invoke-virtual {v0, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths$okhttp(Lokiio/BufferedSink;)V
...
.method public final declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 478
    :cond_5
    iget-object p2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lokiio/BufferedSink;
    ...
    invoke-interface {p2, p3}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
    ...
    .line 480
    invoke-interface {p3, v1}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;

    move-result-object p3

    .line 481
    invoke-interface {p3, p1}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
    ...
    .line 483
    invoke-interface {p2}, Lokiio/BufferedSink;->flush()V
...
.method public declared-synchronized flush()V
    ...
    invoke-interface {v0}, Lokiio/BufferedSink;->flush()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 434
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lokiio/BufferedSink;

    invoke-static {v1}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    sget-object v2, Lokhttp3/internal/cache/DiskLruCache;->READ:Ljava/lang/String;

    invoke-interface {v1, v2}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
    ...
    .line 435
    invoke-interface {v1, v2}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;

    move-result-object v1

    .line 436
    invoke-interface {v1, p1}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
    ...
    .line 437
    invoke-interface {p1, v1}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
...
.method public final declared-synchronized rebuildJournal$okhttp()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lokiio/Sink;

    move-result-object v0

    invoke-static {v0}, Lokiio/Okio;->buffer(Lokiio/Sink;)Lokiio/BufferedSink;
    ...
    check-cast v1, Lokiio/BufferedSink;
    ...
    invoke-interface {v2, v3}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    invoke-interface {v1, v4, v5}, Lokiio/BufferedSink;->writeDecimalLong(J)Lokiio/BufferedSink;
    ...
    .line 393
    invoke-interface {v1, v3}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    invoke-interface {v1, v5}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;

    move-result-object v5

    invoke-interface {v5, v6}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    invoke-interface {v1, v4}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
    ...
    .line 403
    invoke-virtual {v4, v1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths$okhttp(Lokiio/BufferedSink;)V
...
.method public final removeEntry$okhttp(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    invoke-interface {v0, v4}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;

    .line 611
    invoke-interface {v0, v2}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    .line 613
    invoke-interface {v0, v1}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;
    ...
    invoke-interface {v0, v2}, Lokiio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokiio/BufferedSink;
