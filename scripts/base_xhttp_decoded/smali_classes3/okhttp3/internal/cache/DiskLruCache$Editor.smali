...
.method public final newSink(I)Lokiio/Sink;
    .locals 3
    ...
    invoke-interface {v1, p1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lokiio/Sink;
    ...
    invoke-direct {v1, p1, v2}, Lokhttp3/internal/cache/FaultHidingSink;-><init>(Lokiio/Sink;Lkotlin/jvm/functions/Function1;)V
...
.method public final newSource(I)Lokiio/Source;
    .locals 4
    ...
    invoke-interface {v1, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lokiio/Source;
