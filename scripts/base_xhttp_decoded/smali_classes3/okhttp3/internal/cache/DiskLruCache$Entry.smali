...
.method private final newSource(I)Lokiio/Source;
    .locals 2
    ...
    invoke-interface {v0, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lokiio/Source;
    ...
    invoke-direct {v0, p1, v1, p0}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(Lokiio/Source;Lokhttp3/internal/cache/DiskLruCache;Lokhttp3/internal/cache/DiskLruCache$Entry;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-direct {p0, v2}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)Lokiio/Source;
...
.method public final writeLengths$okhttp(Lokiio/BufferedSink;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 986
    invoke-interface {p1, v5}, Lokiio/BufferedSink;->writeByte(I)Lokiio/BufferedSink;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lokiio/BufferedSink;->writeDecimalLong(J)Lokiio/BufferedSink;
