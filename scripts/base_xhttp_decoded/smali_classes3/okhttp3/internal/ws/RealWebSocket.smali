...
.method public constructor <init>(Lokhttp3/internal/concurrent/TaskRunner;Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;JLokhttp3/internal/ws/WebSocketExtensions;J)V
    ...
    .line 135
    sget-object p2, Lokiio/ByteString;->Companion:Lokiio/ByteString$Companion;
    ...
    invoke-static/range {p2 .. p7}, Lokiio/ByteString$Companion;->of$default(Lokiio/ByteString$Companion;[BIIILjava/lang/Object;)Lokiio/ByteString;

    move-result-object p1

    invoke-virtual {p1}, Lokiio/ByteString;->base64()Ljava/lang/String;
...
.method private final declared-synchronized send(Lokiio/ByteString;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILokiio/ByteString;)V
...
.method public final checkUpgradeSuccess$okhttp(Lokhttp3/Response;Lokhttp3/internal/connection/Exchange;)V
    ...
    invoke-virtual {v0}, Lokiio/ByteString;->sha1()Lokiio/ByteString;
...
.method public final declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-virtual {v1, p2}, Lokiio/ByteString$Companion;->encodeUtf8(Ljava/lang/String;)Lokiio/ByteString;
    ...
    invoke-direct {v2, p1, v1, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILokiio/ByteString;J)V
...
.method public final initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    .line 260
    invoke-virtual {p2}, Lokhttp3/internal/ws/RealWebSocket$Streams;->getSink()Lokiio/BufferedSink;
    ...
    .line 258
    invoke-direct/range {v1 .. v8}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLokiio/BufferedSink;Ljava/util/Random;ZZJ)V
    ...
    .line 281
    invoke-virtual {p2}, Lokhttp3/internal/ws/RealWebSocket$Streams;->getSource()Lokiio/BufferedSource;
    ...
    .line 279
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLokiio/BufferedSource;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
...
.method public onReadMessage(Lokiio/ByteString;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, v1, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lokiio/ByteString;)V

    return-void
.end method

.method public declared-synchronized onReadPing(Lokiio/ByteString;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Lokiio/ByteString;)V
    .locals 1
...
.method public final declared-synchronized pong(Lokiio/ByteString;)Z
    .locals 1
...
.method public send(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lokiio/ByteString;I)Z
...
.method public send(Lokiio/ByteString;)Z
    .locals 1
...
.method public final writeOneFrame$okhttp()Z
    ...
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lokiio/ByteString;)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/ws/RealWebSocket$Message;->getData()Lokiio/ByteString;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writeMessageFrame(ILokiio/ByteString;)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/ws/RealWebSocket$Close;->getReason()Lokiio/ByteString;

    move-result-object v4

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILokiio/ByteString;)V
...
.method public final writePingFrame$okhttp()V
    ...
    :cond_3
    :try_start_3
    sget-object v1, Lokiio/ByteString;->EMPTY:Lokiio/ByteString;

    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lokiio/ByteString;)V
    :try_end_3
