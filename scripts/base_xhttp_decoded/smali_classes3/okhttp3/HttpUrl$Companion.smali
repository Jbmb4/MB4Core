...
.method private final writeCanonicalized(Lokiio/Buffer;Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)V
    .locals 9
    ...
    :goto_1
    invoke-virtual {p1, v4}, Lokiio/Buffer;->writeUtf8(Ljava/lang/String;)Lokiio/Buffer;
    ...
    .line 1862
    :cond_4
    invoke-virtual {p1, v3}, Lokiio/Buffer;->writeUtf8CodePoint(I)Lokiio/Buffer;
    ...
    .line 1845
    new-instance v2, Lokiio/Buffer;

    invoke-direct {v2}, Lokiio/Buffer;-><init>()V
    ...
    invoke-virtual {v2, p2, p3, v4, v0}, Lokiio/Buffer;->writeString(Ljava/lang/String;IILjava/nio/charset/Charset;)Lokiio/Buffer;
    ...
    :cond_8
    :goto_3
    invoke-virtual {v2, v3}, Lokiio/Buffer;->writeUtf8CodePoint(I)Lokiio/Buffer;

    .line 1854
    :goto_4
    invoke-virtual {v2}, Lokiio/Buffer;->exhausted()Z
    ...
    .line 1855
    invoke-virtual {v2}, Lokiio/Buffer;->readByte()B
    ...
    .line 1856
    invoke-virtual {p1, v5}, Lokiio/Buffer;->writeByte(I)Lokiio/Buffer;
    ...
    invoke-virtual {p1, v6}, Lokiio/Buffer;->writeByte(I)Lokiio/Buffer;
    ...
    invoke-virtual {p1, v4}, Lokiio/Buffer;->writeByte(I)Lokiio/Buffer;
...
.method private final writePercentDecoded(Lokiio/Buffer;Ljava/lang/String;IIZ)V
    .locals 5
    ...
    .line 1729
    invoke-virtual {p1, p3}, Lokiio/Buffer;->writeByte(I)Lokiio/Buffer;
    ...
    .line 1739
    :cond_1
    invoke-virtual {p1, v0}, Lokiio/Buffer;->writeUtf8CodePoint(I)Lokiio/Buffer;
...
.method public final canonicalize$okhttp(Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    .line 1794
    invoke-virtual {v1, p1, p2, v3}, Lokiio/Buffer;->writeUtf8(Ljava/lang/String;II)Lokiio/Buffer;
    ...
    .line 1795
    invoke-direct/range {v0 .. v10}, Lokhttp3/HttpUrl$Companion;->writeCanonicalized(Lokiio/Buffer;Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)V
...
.method public final percentDecode$okhttp(Ljava/lang/String;IIZ)Ljava/lang/String;
    ...
    .line 1705
    invoke-virtual {v2, p1, p2, v4}, Lokiio/Buffer;->writeUtf8(Ljava/lang/String;II)Lokiio/Buffer;
    ...
    .line 1706
    invoke-direct/range {v1 .. v6}, Lokhttp3/HttpUrl$Companion;->writePercentDecoded(Lokiio/Buffer;Ljava/lang/String;IIZ)V

    .line 1707
    invoke-virtual {v2}, Lokiio/Buffer;->readUtf8()Ljava/lang/String;
