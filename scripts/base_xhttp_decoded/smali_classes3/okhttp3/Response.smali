...
.method public final peekBody(J)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v0}, Lokhttp3/ResponseBody;->source()Lokiio/BufferedSource;

    move-result-object v0

    invoke-interface {v0}, Lokiio/BufferedSource;->peek()Lokiio/BufferedSource;
    ...
    .line 197
    invoke-interface {v0, p1, p2}, Lokiio/BufferedSource;->request(J)Z
    ...
    invoke-virtual {v1, v2, p1, p2}, Lokiio/Buffer;->write(Lokiio/Source;J)Lokiio/Buffer;
    ...
    check-cast p2, Lokiio/BufferedSource;
    ...
    invoke-virtual {p1, p2, v0, v1, v2}, Lokhttp3/ResponseBody$Companion;->create(Lokiio/BufferedSource;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
