.class public final Lokiio/NioFileSystemWrappingFileSystem;
.super Lokiio/NioSystemFileSystem;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lokiio/NioFileSystemWrappingFileSystem;",
        "Lokiio/NioSystemFileSystem;",
        "nioFileSystem",
...
.method public constructor <init>(Ljava/nio/file/FileSystem;)V
    ...
    .line 39
    invoke-direct {p0}, Lokiio/NioSystemFileSystem;-><init>()V

    iput-object p1, p0, Lokiio/NioFileSystemWrappingFileSystem;->nioFileSystem:Ljava/nio/file/FileSystem;
...
.method private final list(Lokiio/Path;Z)Ljava/util/List;
    ...
    .line 66
    invoke-direct {p0, p1}, Lokiio/NioFileSystemWrappingFileSystem;->resolve(Lokiio/Path;)Ljava/nio/file/Path;
    ...
    .line 77
    sget-object v4, Lokiio/Path;->Companion:Lokiio/Path$Companion;

    invoke-static {v4, v0, v1, v2, v3}, Lokiio/Path$Companion;->get$default(Lokiio/Path$Companion;Ljava/nio/file/Path;ZILjava/lang/Object;)Lokiio/Path;
...
.method private final resolve(Lokiio/Path;)Ljava/nio/file/Path;
    .locals 2

    .line 46
    iget-object v0, p0, Lokiio/NioFileSystemWrappingFileSystem;->nioFileSystem:Ljava/nio/file/FileSystem;
...
.method public atomicMove(Lokiio/Path;Lokiio/Path;)V
    ...
    .line 160
    invoke-direct {p0, p2}, Lokiio/NioFileSystemWrappingFileSystem;->resolve(Lokiio/Path;)Ljava/nio/file/Path;
...
.method public canonicalize(Lokiio/Path;)Lokiio/Path;
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lokiio/Path$Companion;->get$default(Lokiio/Path$Companion;Ljava/nio/file/Path;ZILjava/lang/Object;)Lokiio/Path;
...
.method public createDirectory(Lokiio/Path;Z)V
    ...
    .line 143
    invoke-virtual {p0, p1}, Lokiio/NioFileSystemWrappingFileSystem;->metadataOrNull(Lokiio/Path;)Lokiio/FileMetadata;
...
.method public list(Lokiio/Path;)Ljava/util/List;
    ...
    .line 61
    invoke-direct {p0, p1, v0}, Lokiio/NioFileSystemWrappingFileSystem;->list(Lokiio/Path;Z)Ljava/util/List;
...
.method public metadataOrNull(Lokiio/Path;)Lokiio/FileMetadata;
    ...
    invoke-virtual {p0, p1}, Lokiio/NioFileSystemWrappingFileSystem;->metadataOrNull(Ljava/nio/file/Path;)Lokiio/FileMetadata;
...
.method public openReadOnly(Lokiio/Path;)Lokiio/FileHandle;
    ...
    .line 88
    new-instance v0, Lokiio/NioFileSystemFileHandle;

    invoke-static {p1}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    invoke-direct {v0, v3, p1}, Lokiio/NioFileSystemFileHandle;-><init>(ZLjava/nio/channels/FileChannel;)V
...
.method public openReadWrite(Lokiio/Path;ZZ)Lokiio/FileHandle;
    ...
    .line 108
    new-instance p2, Lokiio/NioFileSystemFileHandle;

    invoke-static {p1}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    const/4 p3, 0x1

    invoke-direct {p2, p3, p1}, Lokiio/NioFileSystemFileHandle;-><init>(ZLjava/nio/channels/FileChannel;)V
...
.method public sink(Lokiio/Path;Z)Lokiio/Sink;
    ...
    .line 126
    invoke-static {p2}, Lokiio/Okio;->sink(Ljava/io/OutputStream;)Lokiio/Sink;
