.class public Lokiio/NioSystemFileSystem;
.super Lokiio/JvmSystemFileSystem;
...
.method public constructor <init>()V
    ...
    .line 33
    invoke-direct {p0}, Lokiio/JvmSystemFileSystem;-><init>()V
...
.method public atomicMove(Lokiio/Path;Lokiio/Path;)V
    ...
    .line 78
    :try_start_0
    invoke-virtual {p1}, Lokiio/Path;->toNioPath()Ljava/nio/file/Path;

    move-result-object p1

    invoke-virtual {p2}, Lokiio/Path;->toNioPath()Ljava/nio/file/Path;
...
.method protected final metadataOrNull(Ljava/nio/file/Path;)Lokiio/FileMetadata;
    .locals 19
    ...
    .line 57
    :goto_0
    new-instance v8, Lokiio/FileMetadata;
    ...
    .line 60
    sget-object v5, Lokiio/Path;->Companion:Lokiio/Path$Companion;

    invoke-static {v5, v1, v7, v4, v2}, Lokiio/Path$Companion;->get$default(Lokiio/Path$Companion;Ljava/nio/file/Path;ZILjava/lang/Object;)Lokiio/Path;
    ...
    invoke-direct {v0, v1}, Lokiio/NioSystemFileSystem;->zeroToNull(Ljava/nio/file/attribute/FileTime;)Ljava/lang/Long;
    ...
    .line 57
    invoke-direct/range {v8 .. v18}, Lokiio/FileMetadata;-><init>(ZZLokiio/Path;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/util/Map;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public metadataOrNull(Lokiio/Path;)Lokiio/FileMetadata;
    ...
    invoke-virtual {p0, p1}, Lokiio/NioSystemFileSystem;->metadataOrNull(Ljava/nio/file/Path;)Lokiio/FileMetadata;
