.class public final Loiko/NioFileSystemWrappingFileSystem;
.super Loiko/NioSystemFileSystem;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Loiko/NioFileSystemWrappingFileSystem;",
        "Loiko/NioSystemFileSystem;",
        "nioFileSystem",
...
.method public constructor <init>(Ljava/nio/file/FileSystem;)V
    ...
    .line 39
    invoke-direct {p0}, Loiko/NioSystemFileSystem;-><init>()V

    iput-object p1, p0, Loiko/NioFileSystemWrappingFileSystem;->nioFileSystem:Ljava/nio/file/FileSystem;
...
.method private final list(Loiko/Path;Z)Ljava/util/List;
    ...
    .line 66
    invoke-direct {p0, p1}, Loiko/NioFileSystemWrappingFileSystem;->resolve(Loiko/Path;)Ljava/nio/file/Path;
    ...
    .line 77
    sget-object v4, Loiko/Path;->Companion:Loiko/Path$Companion;

    invoke-static {v4, v0, v1, v2, v3}, Loiko/Path$Companion;->get$default(Loiko/Path$Companion;Ljava/nio/file/Path;ZILjava/lang/Object;)Loiko/Path;
...
.method private final resolve(Loiko/Path;)Ljava/nio/file/Path;
    .locals 2

    .line 46
    iget-object v0, p0, Loiko/NioFileSystemWrappingFileSystem;->nioFileSystem:Ljava/nio/file/FileSystem;
...
.method public appendingSink(Loiko/Path;Z)Loiko/Sink;
    ...
    .line 139
    invoke-static {p1}, Loiko/Okio;->sink(Ljava/io/OutputStream;)Loiko/Sink;
...
.method public atomicMove(Loiko/Path;Loiko/Path;)V
    ...
    .line 160
    invoke-direct {p0, p2}, Loiko/NioFileSystemWrappingFileSystem;->resolve(Loiko/Path;)Ljava/nio/file/Path;
...
.method public canonicalize(Loiko/Path;)Loiko/Path;
    ...
    invoke-static {v0, v1, v2, v3, v4}, Loiko/Path$Companion;->get$default(Loiko/Path$Companion;Ljava/nio/file/Path;ZILjava/lang/Object;)Loiko/Path;
...
.method public createDirectory(Loiko/Path;Z)V
    ...
    .line 143
    invoke-virtual {p0, p1}, Loiko/NioFileSystemWrappingFileSystem;->metadataOrNull(Loiko/Path;)Loiko/FileMetadata;
    ...
    invoke-virtual {v0}, Loiko/FileMetadata;->isDirectory()Z
...
.method public list(Loiko/Path;)Ljava/util/List;
    ...
    .line 61
    invoke-direct {p0, p1, v0}, Loiko/NioFileSystemWrappingFileSystem;->list(Loiko/Path;Z)Ljava/util/List;
...
.method public metadataOrNull(Loiko/Path;)Loiko/FileMetadata;
    ...
    invoke-virtual {p0, p1}, Loiko/NioFileSystemWrappingFileSystem;->metadataOrNull(Ljava/nio/file/Path;)Loiko/FileMetadata;
...
.method public openReadOnly(Loiko/Path;)Loiko/FileHandle;
    ...
    .line 88
    new-instance v0, Loiko/NioFileSystemFileHandle;

    invoke-static {p1}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    invoke-direct {v0, v3, p1}, Loiko/NioFileSystemFileHandle;-><init>(ZLjava/nio/channels/FileChannel;)V
...
.method public openReadWrite(Loiko/Path;ZZ)Loiko/FileHandle;
    ...
    .line 108
    new-instance p2, Loiko/NioFileSystemFileHandle;

    invoke-static {p1}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    const/4 p3, 0x1

    invoke-direct {p2, p3, p1}, Loiko/NioFileSystemFileHandle;-><init>(ZLjava/nio/channels/FileChannel;)V

    check-cast p2, Loiko/FileHandle;
...
.method public sink(Loiko/Path;Z)Loiko/Sink;
    ...
    .line 126
    invoke-static {p2}, Loiko/Okio;->sink(Ljava/io/OutputStream;)Loiko/Sink;
