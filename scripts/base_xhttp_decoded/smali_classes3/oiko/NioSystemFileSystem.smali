.class public Loiko/NioSystemFileSystem;
.super Loiko/JvmSystemFileSystem;
...
.method public constructor <init>()V
    ...
    .line 33
    invoke-direct {p0}, Loiko/JvmSystemFileSystem;-><init>()V
...
.method public atomicMove(Loiko/Path;Loiko/Path;)V
    ...
    .line 78
    :try_start_0
    invoke-virtual {p1}, Loiko/Path;->toNioPath()Ljava/nio/file/Path;

    move-result-object p1

    invoke-virtual {p2}, Loiko/Path;->toNioPath()Ljava/nio/file/Path;
...
.method protected final metadataOrNull(Ljava/nio/file/Path;)Loiko/FileMetadata;
    .locals 19
    ...
    .line 57
    :goto_0
    new-instance v8, Loiko/FileMetadata;
    ...
    .line 60
    sget-object v5, Loiko/Path;->Companion:Loiko/Path$Companion;

    invoke-static {v5, v1, v7, v4, v2}, Loiko/Path$Companion;->get$default(Loiko/Path$Companion;Ljava/nio/file/Path;ZILjava/lang/Object;)Loiko/Path;
    ...
    invoke-direct {v0, v1}, Loiko/NioSystemFileSystem;->zeroToNull(Ljava/nio/file/attribute/FileTime;)Ljava/lang/Long;
    ...
    .line 57
    invoke-direct/range {v8 .. v18}, Loiko/FileMetadata;-><init>(ZZLoiko/Path;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/util/Map;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public metadataOrNull(Loiko/Path;)Loiko/FileMetadata;
    ...
    invoke-virtual {p0, p1}, Loiko/NioSystemFileSystem;->metadataOrNull(Ljava/nio/file/Path;)Loiko/FileMetadata;
