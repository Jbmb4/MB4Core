...
.method private declared-synchronized makePinger()V
    ...
    .line 621
    # Publish every successful ping. The original code checked lastPingLatency
    # and emitted MSG_PING_RESULT only while the cached value was negative.
    ...
    invoke-static {v4}, Lcom/dragonssh/xhttpdemo/core/tunnel/TunnelManagerThread;->-$$Nest$fgetmContext(Lcom/dragonssh/xhttpdemo/core/tunnel/TunnelManagerThread;)Landroid/content/Context;
    ...
    sget-object v6, Le4/g;->B:Le4/g;

    invoke-virtual {v6, v4, v5}, Le4/g;->b(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_0
